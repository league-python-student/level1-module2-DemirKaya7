...
class FirstApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.label = tk.Label(self, text="My First App", bg='black',
        ...
        self.label2 = tk.Label(self, image=self.img, bg='yellow',
                              fg='blue', font=('arial', 32, 'bold'), relief='solid')
        # TODO 8) Place the label somewhere on your app
        self.label2.place(relx=0.1, rely=0.3, relwidth=0.8, relheight=0.6)
